...
if [ -n "$ASH_BIN_URL" ]; then
    ...
    URL="https://github.com/dreamyang-liu/Ash/releases/latest/download/ash-runtime-linux-${ASH_ARCH}"
    ...
    URL="https://github.com/dreamyang-liu/Ash/releases/download/v${ASH_VERSION}/ash-runtime-linux-${ASH_ARCH}"
