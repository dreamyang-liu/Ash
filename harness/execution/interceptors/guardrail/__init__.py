...
read (`state.py`), the predicates that classify a call (`classify.py`), and the
interceptor that turns the two into a verdict (`interceptor.py`). A different rule
reuses the first two and ships its own interceptor.
"""
